...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_response')) {
        Object.defineProperty(Module['ready'], '_get_response', { configurable: true, get: function() { abort('You are getting _get_response on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_response', { configurable: true, set: function() { abort('You are setting _get_response on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'mz_web.wasm';
...
/** @type {function(...*):?} */
var _get_response = Module["_get_response"] = createExportWrapper("get_response");
